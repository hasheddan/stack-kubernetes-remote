...
import (
	...
	"github.com/hasheddan/stack-kubernetes-remote/pkg/controller"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("stack-kubernetes-remote"))
	if *debug {
	...
	kingpin.FatalIfError(controller.Setup(mgr, log), "Cannot setup Kubernetes Remote controllers")
